const darkMap = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": "https://api.maptiler.com/tiles/v3/tiles.json?key=oLrAa6vuGOa0v02TPt5z"
    }
  },
  "sprite": "https://api.maptiler.com/maps/darkmatter/sprite",
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=oLrAa6vuGOa0v02TPt5z",
  "layers": [{
      "id": "background",
      "type": "background",
      "paint": {
